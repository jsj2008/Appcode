...
- (void)setTitle:(NSString *)title forSegmentAtIndex:(NSUInteger)segment
{
    ...
    UILabel *segmentView = [self._items objectAtIndex:index];
...
- (void)insertSegmentWithTitle:(NSString *)title atIndex:(NSUInteger)segment animated:(BOOL)animated
{
    ...
    segmentView.font = [UIFont boldSystemFontOfSize:13];
    ...
    if (index < self._items.count)
    {
        ...
        [self insertSubview:segmentView belowSubview:[self._items objectAtIndex:index]];
...
- (void)layoutSegments
{
    ...
    {
        UIView *selectedItem = [self._items objectAtIndex:self.selectedSegmentIndex];

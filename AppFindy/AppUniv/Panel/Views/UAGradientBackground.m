...
- (void)drawRect:(CGRect)rect {
	...
	switch (gradientStyle) {
        ...
        case UAGradientBackgroundStyleNone:{
            CGFloat myLocations[1] = { 0.0 };
			CGFloat myColorComponents[1] = { colorComponents[5] };
			CGGradientRef myGradient = CGGradientCreateWithColorComponents (myColorspace, myColorComponents, myLocations, 1);
			CGContextDrawLinearGradient(context, myGradient, CGPointMake(0.0,0.0), CGPointMake(0.0,rect.size.height+1), 0);
			CGGradientRelease(myGradient);
            break;
        }

...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.titleBar.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"navigation_bg"]];
        
        
        /*[UANoisyGradientBackground gradientWithFrame:CGRectZero
		...
		self.headerLabel.font = [UIFont fontWithName:AUVBoldFont size:24];

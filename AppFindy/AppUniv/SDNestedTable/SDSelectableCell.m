...
- (void) styleEnabled
{
    ...
    checkBox.alpha = 1.0;
    itemText.alpha = 1.0;
    self.backgroundView.backgroundColor = [UIColor clearColor];//UIColorFromRGBWithAlpha(0x081c2f, 1.0); 
}
...
- (void) styleDisabled
{
    ...
    checkBox.alpha = 1.0;
    itemText.alpha = 0.4;
    self.backgroundView.backgroundColor =[UIColor clearColor]; //[UIColor colorWithWhite:0.0 alpha:1.0]; 
}

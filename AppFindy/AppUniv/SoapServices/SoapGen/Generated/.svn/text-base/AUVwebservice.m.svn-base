...
@implementation AUVwebservice
	...
	- (id) init
	{
		if(self = [super init])
		{
			self.serviceUrl = @"http://appfindy.com/en/index.php/webservice";
			self.namespace = @"http://appfindy.com/en/index.php/webservice";
			self.headers = nil;
			self.logging = NO;
		}
		return self;
	...
	{
		return [self register: handler action: nil username: username password: password email_id: email_id];
	}

	- (SoapRequest*) register: (id) _target action: (SEL) _action username: (NSString*) username password: (NSString*) password email_id: (NSString*) email_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self suggest_friends: handler action: nil user_id: user_id];
	}

	- (SoapRequest*) suggest_friends: (id) _target action: (SEL) _action user_id: (NSString*) user_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self get_comment: handler action: nil app_id: app_id];
	}

	- (SoapRequest*) get_comment: (id) _target action: (SEL) _action app_id: (NSString*) app_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self wall: handler action: nil user_id: user_id];
	}

	- (SoapRequest*) wall: (id) _target action: (SEL) _action user_id: (NSString*) user_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self question: handler action: nil category_id: category_id app_id: app_id user_id: user_id question: question];
	}

	- (SoapRequest*) question: (id) _target action: (SEL) _action category_id: (NSString*) category_id app_id: (NSString*) app_id user_id: (NSString*) user_id question: (NSString*) question
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self user_followers_list: handler action: nil user_id: user_id];
	}

	- (SoapRequest*) user_followers_list: (id) _target action: (SEL) _action user_id: (NSString*) user_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self app_followers_list: handler action: nil user_id: user_id app_id: app_id];
	}

	- (SoapRequest*) app_followers_list: (id) _target action: (SEL) _action user_id: (NSString*) user_id app_id: (NSString*) app_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self category_followers_list: handler action: nil user_id: user_id category_id: category_id];
	}

	- (SoapRequest*) category_followers_list: (id) _target action: (SEL) _action user_id: (NSString*) user_id category_id: (NSString*) category_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self question_followers_list: handler action: nil user_id: user_id question_id: question_id];
	}

	- (SoapRequest*) question_followers_list: (id) _target action: (SEL) _action user_id: (NSString*) user_id question_id: (NSString*) question_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self following_list: handler action: nil user_id: user_id];
	}

	- (SoapRequest*) following_list: (id) _target action: (SEL) _action user_id: (NSString*) user_id
		{
		NSMutableArray* _params = [NSMutableArray array];
	...
	{
		return [self notification: handler action: nil user_id: user_id];
	}

	- (SoapRequest*) notification: (id) _target action: (SEL) _action user_id: (NSString*) user_id
		{
		NSMutableArray* _params = [NSMutableArray array];

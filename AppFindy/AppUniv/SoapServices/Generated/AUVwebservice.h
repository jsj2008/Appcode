...
@interface AUVwebservice : SoapService
	...
	- (SoapRequest*) myapps: (id) target action: (SEL) action user_id: (NSString*) user_id app_id: (NSString*) app_id type: (NSString*) type;
...
- (SoapRequest*) update_PushNotification: (id) target action: (SEL) action user_id: (NSString*) user_id notification: (NSString*) notification;
 ...
 //   - (SoapRequest*) register: (id <SoapDelegate>) handler firstname:(NSString*)fname username: (NSString*) username password: (NSString*) password email_id: (NSString*) email_id;
  ...
  //  - (SoapRequest*) register: (id) _target action: (SEL) _action firstname:(NSString*)fname username: (NSString*) username password: (NSString*) password email_id: (NSString*) email_id;
...
- (SoapRequest*) suggest_friends: (id <SoapDelegate>) handler user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*)offset;
	- (SoapRequest*) suggest_friends: (id) target action: (SEL) action user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*)offset;
	...
	- (SoapRequest*) update_user_interest: (id) target action: (SEL) action user_id: (NSString*) user_id category_id: (NSString*) category_id;
	...
	- (SoapRequest*) get_comment: (id) target action: (SEL) action app_id: (NSString*) app_id limit: (NSString*) limit offset: (NSString*) offset;
...
;
- (SoapRequest*) wall: (id) target action: (SEL) action user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*)offset
;
...
- (SoapRequest*) question: (id <SoapDelegate>) handler category_id: (NSString*) category_id app_id: (NSString*) app_id user_id: (NSString*) user_id question: (NSString*) question description:(NSString*) description;
	- (SoapRequest*) question: (id) target action: (SEL) action category_id: (NSString*) category_id app_id: (NSString*) app_id user_id: (NSString*) user_id question: (NSString*) question description:(NSString*) description;
    ...
    - (SoapRequest*) user_followers_list: (id) target action: (SEL) action user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*) offset;
	...
	- (SoapRequest*) app_followers_list: (id) target action: (SEL) action user_id: (NSString*) user_id app_id: (NSString*) app_id limit:(NSString*)limit offset:(NSString*)offset;
	...
	- (SoapRequest*) category_followers_list: (id) target action: (SEL) action user_id: (NSString*) user_id category_id: (NSString*) category_id limit:(NSString*)limit offset:(NSString*)offset;
	...
	- (SoapRequest*) question_followers_list: (id) target action: (SEL) action user_id: (NSString*) user_id question_id: (NSString*) question_id limit:(NSString*)limit offset:(NSString*)offset;
    ...
    - (SoapRequest*) following_list: (id) target action: (SEL) action user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*)offset;
	...
	- (SoapRequest*) notification: (id) target action: (SEL) action user_id: (NSString*) user_id limit: (NSString*) limit offset: (NSString*) offset;
	...
	- (SoapRequest*) facebook_find_friends: (id) target action: (SEL) action user_id: (NSString*) user_id facebook_user_id: (NSString*) facebook_user_id;

	/* Returns AUVArray*. Get User Interest */
	- (SoapRequest*) get_user_interest: (id <SoapDelegate>) handler user_id: (NSString*) user_id;
	- (SoapRequest*) get_user_interest: (id) target action: (SEL) action user_id: (NSString*) user_id;
	...
	- (SoapRequest*) get_follow_question: (id) target action: (SEL) action user_id: (NSString*) user_id limit: (NSString*) limit offset: (NSString*) offset;

	/* Returns AUVArray*. Get Follow Apps */
	- (SoapRequest*) get_follow_apps: (id <SoapDelegate>) handler user_id: (NSString*) user_id;
	- (SoapRequest*) get_follow_apps: (id) target action: (SEL) action user_id: (NSString*) user_id;
    ...
    - (SoapRequest*) credit_transactions: (id) target action: (SEL) action user_id: (NSString*) user_id limit:(NSString*)limit offset:(NSString*)offset;

		
    /* Returns AUVArray*. get myapps details */
    - (SoapRequest*) get_myapps_details: (id <SoapDelegate>) handler user_id: (NSString*) user_id;
    - (SoapRequest*) get_myapps_details: (id) target action: (SEL) action user_id: (NSString*) user_id;

    /* Returns AUVArray*. category page */
    - (SoapRequest*) category_page: (id <SoapDelegate>) handler user_id: (NSString*) user_id category_id:(NSString*)category_id;
    - (SoapRequest*) category_page: (id) target action: (SEL) action user_id: (NSString*) user_id category_id:(NSString*)category_id;
    /* Returns AUVArray*. Deals */
    - (SoapRequest*) deals: (id <SoapDelegate>) handler;
    - (SoapRequest*) deals: (id) target action: (SEL) action;
    ...
    - (SoapRequest*) apps_recommend: (id) target action: (SEL) action user_id: (NSString*) user_id limit: (NSString*) limit offset: (NSString*) offset;
...
- (SoapRequest*) suggest: (id) target action: (SEL) action user_id: (NSString*) user_id ref_user_id:(NSString*) ref_user_id a_id: (NSString*) a_id type:(NSString*) type;

    /* Returns AUVArray*. App Share */
    - (SoapRequest*) appshare: (id <SoapDelegate>) handler user_id: (NSString*) user_id app_id: (NSString*) app_id;
    - (SoapRequest*) appshare: (id) target action: (SEL) action user_id: (NSString*) user_id app_id: (NSString*) app_id;
    ...
    /* Returns AUVArray*. Fb Linked Account */

...
- (UIImage*) getCroppedImage {
    ...
    // grab image
    UIImage* croppedImage = [self imageWithImage:UIGraphicsGetImageFromCurrentImageContext() scaledToWidth:120.0f];//[self imageByScalingToSize:CGSizeMake(120,120) image:UIGraphicsGetImageFromCurrentImageContext()];
